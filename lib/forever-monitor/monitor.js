...
var Monitor = exports.Monitor = function (script, options) {
  ...
  // d1b1 - User Defined Fields.
  this.ui_name   = options.ui_name || '';
  this.ui_port   = options.ui_port || '';
  this.ui_sha    = options.ui_sha  || '';
  this.ui_owner  = options.ui_owner || '';
  this.ui_description = options.ui_description || '';
  this.ui_url         = options.ui_url || '';
  // Types: snapshot or head.
  this.ui_type        = options.ui_type || '';
  this.ui_repo = options.ui_repo || '';
...
Monitor.prototype.__defineGetter__('data', function () {
  ...
  childData = {
    ...
    // d1b1 - Custom Fields. Tagged v0.1
    ui_name: this.ui_name || '',
    ui_port: this.ui_port || '',
    ui_sha:  this.ui_sha || '',
    ui_owner: this.ui_owner || '',
    ui_description: this.ui_description || '',
    ui_url: this.ui_url || '',
    ui_type: this.ui_type || '',
		ui_repo: this.ui_repo || ''
  };
